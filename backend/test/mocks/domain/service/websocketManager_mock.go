...
// Source: /home/nakamuraitsuki/program/webRTC-practice2/backend/internal/domain/service/websocketManager.go
//
// Generated by this command:
//
//	mockgen -source=/home/nakamuraitsuki/program/webRTC-practice2/backend/internal/domain/service/websocketManager.go -destination=test/mocks/domain/service/websocketManager_mock.go
//
...
func (m *MockWebsocketManager) BroadcastToRoom(ctx context.Context, roomID entity.RoomID, msgType service.MsgType, msg any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BroadcastToRoom", ctx, roomID, msgType, msg)
	ret0, _ := ret[0].(error)
	return ret0
}

// BroadcastToRoom indicates an expected call of BroadcastToRoom.
func (mr *MockWebsocketManagerMockRecorder) BroadcastToRoom(ctx, roomID, msgType, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BroadcastToRoom", reflect.TypeOf((*MockWebsocketManager)(nil).BroadcastToRoom), ctx, roomID, msgType, msg)
}
